            ...
            {!! Form::open(['url' => 'category/update', 'method' => 'POST', 'class' => 'form-horizontal']) !!}  
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="first-name" name="category_name" value="{{ $categoryById->category_name}}" class="form-control ">
                  <input type="hidden" id="first-name" name="id" value="{{ $categoryById->id}}" class="form-control ">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="last-name" name="category_url" value="{{ $categoryById->category_url}}" class="form-control">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input class="form-control" type="number" name="category_position" value="{{ $categoryById->category_position}}">
