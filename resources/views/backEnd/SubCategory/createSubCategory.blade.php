      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            {!! Form::open(['url' => 'sub_category/save', 'method' => 'POST', 'class' => 'form-horizontal']) !!}  
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  ...
                  <!-- <input type="text" id="first-name" name="category_id" required="required" class="form-control ">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="last-name" name="sub_category_name" required="required" class="form-control">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input id="middle-name" class="form-control" type="text" name="sub_category_url">
              ...
              <div class="item form-group">
                <div class="col-md-6 col-sm-6 offset-md-3">
                   ...
                   <button type="submit" class="btn btn-success"> Sub Category Save</button>
                </div>
              </div>
            {!! Form::close() !!}
          </div>
